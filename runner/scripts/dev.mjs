...
// for the user-facing walkthrough, and this task's report
// (.superpowers/sdd/README/final/L1-report.md) for the design rationale —
// in particular the wrangler `.dev.vars`-always-wins-over-`--var`
// precedence finding that shapes `dev-lib.mjs`'s bootstrap/patch design.
//
