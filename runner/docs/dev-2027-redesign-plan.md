...
| 6 | The example pill's 20×20 Handsontable mark has no asset in the repo | asset gap | T2 |
| 7 | Tier-1 has no preview URL to put in the row-2 address field | design decision | T2 |
...
### 6. The example pill's Handsontable mark has no asset (asset gap)
...
### 7. Tier 1 has no preview URL for the row-2 address field (design decision)
