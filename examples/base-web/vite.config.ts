...
// gate in src/hotTheme.ts guarantees the stub is never executed.
    ...
    : [
        {
          ...
          replacement: path.resolve(__dirname, 'src/hotThemesCompat.ts'),
        },
      ];
...
export default defineConfig({
  ...
  optimizeDeps: {
    include: ['handsontable', '@handsontable/react-wrapper', 'baseui', 'styletron-react', 'styletron-engine-atomic'],
  },
});
