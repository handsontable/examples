...
// gate in src/hotTheme.js guarantees the stub is never executed.
const hotManifest = JSON.parse(
  readFileSync(path.join(import.meta.dirname, 'node_modules/handsontable/package.json'), 'utf8')
);
    ...
    : [
        {
          ...
          replacement: path.resolve(import.meta.dirname, 'src/hotThemesCompat.js'),
        },
      ];
