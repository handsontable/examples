...
| Backend  | Express.js 4 + TypeScript + Zod               |
| ORM      | TypeORM 0.3                                   |
...
3. Installs Express server dependencies (`npm install`)
4. Runs TypeORM migrations — creates the `tickets` table and seeds 12 sample rows
5. Starts the Express backend on **http://localhost:3000**
...
| URL | Description |
|-----|-------------|
| `http://localhost:5173/` | Vanilla JS |
